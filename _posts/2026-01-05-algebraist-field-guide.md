...
With that in mind, we'll walk through some standard ways of building the main number systems -- from $\mathbb{Z}$ up to $\mathbb{O}$ -- with a distinctive algebraic flavour, noting what each construction buys you and what it costs. Read this post at your level. The constructions are there if you want them -- the mathematician feelings are there if you don't. One attribution: this post benefited from conversations with an AI assistant who is very patient with algebraists.
