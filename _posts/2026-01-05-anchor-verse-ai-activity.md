...
|----------------------------------------------|----------------------------------------------------|
| **How most people use AI:**<br>• 'Give me the answer.'<br>• 'Do this for me.' | **The mode we want:**<br>• 'Help me build something.'<br>• 'Reflect back what I'm saying.'<br>• 'Ask me questions.'<br>• 'Support my discernment.'<br>• 'Help me think, not think for me.' |
...
| **Spiritual danger** -- mirrors consumeristic faith:<br>• 'Feed me.'<br>• 'Fix me.'<br>• 'Tell me what to do.'<br>• 'Do my thinking for me.' | **Spiritual alignment** -- mirrors lived, organic faith:<br>• formation over consumption<br>• participation over passivity<br>• discernment over outsourcing<br>• wisdom over shortcuts |
...
<!-- My example shared privately with friends: Romans 1:16 on Sunday 21 December -->
<!-- Anchor verse AI activity – Lawrence (Romans 1:16): https://copilot.microsoft.com/shares/jUj22HzMFaw27thYU77JL -->
<!-- Copilot Pages version for facilitators: https://copilot.microsoft.com/shares/pages/i9NFRVWJFATWG81VijGDs -->

If you'd like to [jump straight to the activity](#bible-anchor-verse-activity), feel free. But the grounding that follows is what makes the activity spiritually safe, wise and genuinely formative, so I encourage you to sit with it first.
...
*For facilitators: this activity can be run as a group activity, with facilitator notes and discussion questions available on [Copilot Pages](https://copilot.microsoft.com/shares/pages/i9NFRVWJFATWG81VijGDs).*
