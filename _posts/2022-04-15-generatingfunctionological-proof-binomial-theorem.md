...
this is an equality in the formal sense, where we don't care about convergence. (Note that the series converges when $$\lvert x\rvert < 1$$ in the analytic sense.)
